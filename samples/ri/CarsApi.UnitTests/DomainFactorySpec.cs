...
namespace CarsApi.UnitTests
{
    ...
    public class DomainFactorySpec
    {
        ...
        {
            this.factory.RegisterTypesFromAssemblies(typeof(ServiceHost).Assembly);
    ...
    {
        private TestEntity(ILogger logger, IIdentifierFactory idFactory) : base(logger, idFactory)
        {
        }
